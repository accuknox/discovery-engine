...
## ./scripts/observe_db_clear.sh --clustername default --containername wordpress --namespace wordpress-mysql --labels app=mysql
...
grpcurl -plaintext -d "$DATA" localhost:9089 v1.observability.Observability.ClearDb
