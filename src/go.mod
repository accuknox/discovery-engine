...
require (
	...
	github.com/kubearmor/KubeArmor/protobuf v0.0.0-20230420155022-a3b23a0702fb
...
require (
	...
	github.com/AthenZ/athenz v1.11.27 // indirect
	...
	github.com/ProtonMail/go-crypto v0.0.0-20230424115807-0a3aa4e1271a // indirect
